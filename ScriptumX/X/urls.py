...
urlpatterns = [
    ...
    url(r'^scene/(?P<sceneitem_id>\d+)/new/(?P<sceneitem_type>[NADT])/(?P<offset>[-]?\d+)$', X.view_scene.sceneNew, name='sceneNew'),
    url(r'^scene/(?P<sceneitem_id>\d+)/move/(?P<offset>[-]?\d+)$', X.view_scene.sceneMove, name='sceneMove'),
